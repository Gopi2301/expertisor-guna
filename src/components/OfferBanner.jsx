...
const OfferBanner = ({ offer_detail, courseId }) => {
  // total duration
  ...
  const Coupon = () => (
    <div className="flex gap-2 items-center">
      ...
      <p className="lg:block hidden text-[#8A8A8A] font-inter font-normal text-[14px] leading-[16px]">
        Coupon Code
      </p>
  ...
  const Actions = () => (
    <div className="flex items-center gap-2">
      ...
      {offer_detail.d_broucher && (
        ...
        >
          <span className="hidden md:block text-[14px] lg:text-[18px]">
            Brochure
          </span>
          <Download size={18} />
        </a>
