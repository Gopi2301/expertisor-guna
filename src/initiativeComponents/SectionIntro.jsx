...
const SectionIntro = ({ urlParams = {} }) => {
    ...
    return (
        <section className=' bg-[radial-gradient(83.9%_46.38%_at_50%_0%,_#FFFFFF_0%,_#FFF200_100%)]'>
            ...
            <div className='pt-32 sm:pt-44 pb-24 px-3 sm:px-5' >
                ...
                <div className=' text-center'>
                    ...
                    <div className='relative  inline-block mb-4'>
                        ...
                        <div className=' hidden sm:flex justify-center gap-4 mt-8 mb-10 lg:mb-14'>
                            ...
                            <div className='flex justify-center cursor-pointer'>
                                <button onClick={() => setIsModalOpen(true)} className='flex justify-center items-center  w-[171px] h-[56px] rounded-[8px]  bg-[radial-gradient(99.88%_99.88%_at_53.29%_100.71%,_#6D6100_0%,_#000000_100%)] border border-[#B6AC00]'>
                                    <div className="flex gap-3 items-center">
                                        <span className='font-inter font-semibold text-[16px] text-[#FFF201] leading-[100%] tracking-[0%] align-middle'>Apply Now</span>
                            ...
                            <a href="/expertisor Academy Brochure.pdf" download className='flex justify-center cursor-pointer'>
                    ...
                    <div className=' block sm:hidden justify-center gap-4 mt-12 '>
                        ...
                        <div className='flex justify-center cursor-pointer'>
                            <button onClick={() => setIsModalOpen(true)} className='flex justify-center items-center  w-[335px] h-[48px] rounded-[8px]  bg-[radial-gradient(99.88%_99.88%_at_53.29%_100.71%,_#6D6100_0%,_#000000_100%)] border border-[#B6AC00]'>
                                <div className="flex gap-3 items-center">
            ...
            <ApplyModal open={isModalOpen} onClose={() => setIsModalOpen(false)} courseId={pages.techbundle.deal_course_id} />
        </section>
    )
}
